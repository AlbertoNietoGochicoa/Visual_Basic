...
Module Module1
    ...
    Sub Main()
        ...
        Dim path As String = "C:\Users\Lenovo\Documents\Visual Studio 2015\Projects\imputoutput\ejerciciop610\ejerciciop610\p610.txt"
        ...
        Dim prueba As Byte() = New UTF8Encoding(True).GetBytes("Me estoy quitando, solamente me pongo en veen cuando")
